...
groups = [
                ...
                Group("4",
                      ...
                      matches=[Match(title="New Tab - Vivaldi"), ],
                      label=" 爵 "),
                Group("5",
                      matches=[Match(wm_class="nvim-qt"), ],
                      label="  "),
                Group("6",
                      label="  "),
                Group("7",
                      spawn=["firefox https://web.whatsapp.com", "firefox -e https://www.messenger.com/t/1752361098145334/"],
                      label="  "),
                Group("8",
                      spawn="spotify",
                      label="  "),
